...
export default function ModelPortfolioShoot() {
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        <img
          src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=1200&h=600&fit=crop"
        ...
        <div className="relative z-10 text-center px-6">
          ...
          <p className="text-gray-300 max-w-3xl mx-auto">
            Complete professional portfolio shoots for aspiring models with multiple looks, premium styling and high-end retouching.
          </p>
        </div>
      </section>
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li className="flex items-center gap-3">
              ...
              <span className="text-lg text-gray-300">Multiple look changes</span>
            </li>

            <li className="flex items-center gap-3">
              <CheckCircle className="text-[#D4AF37] w-6 h-6" />
              <span className="text-lg text-gray-300">Professional makeup & styling</span>
            </li>

            <li className="flex items-center gap-3">
              <CheckCircle className="text-[#D4AF37] w-6 h-6" />
              <span className="text-lg text-gray-300">Studio & outdoor shoot options</span>
            </li>

            <li className="flex items-center gap-3">
              <CheckCircle className="text-[#D4AF37] w-6 h-6" />
              <span className="text-lg text-gray-300">High-resolution edited images</span>
            </li>

            <li className="flex items-center gap-3">
              <CheckCircle className="text-[#D4AF37] w-6 h-6" />
              <span className="text-lg text-gray-300">Portfolio & career consultation</span>
            </li>
          </ul>
        </div>
