...
export default function ModelActor() {
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-6">
          ...
          <p className="text-gray-300 max-w-3xl mx-auto">
            Professional modeling & acting services for fashion, commercial and entertainment projects.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-16">
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li className="flex items-center gap-3">
              ...
              <span className="text-lg text-gray-300">Fashion modeling</span>
            </li>
            ...
            <li className="flex items-center gap-3">
              <CheckCircle className="text-[#D4AF37] w-6 h-6" />
              <span className="text-lg text-gray-300">Acting for films & TV</span>
            </li>

            <li className="flex items-center gap-3">
              <CheckCircle className="text-[#D4AF37] w-6 h-6" />
              <span className="text-lg text-gray-300">Brand ambassador services</span>
            </li>

            <li className="flex items-center gap-3">
              <CheckCircle className="text-[#D4AF37] w-6 h-6" />
              <span className="text-lg text-gray-300">Event appearances</span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-[#0f0f0f] border border-[#D4AF37] rounded-3xl p-10">
          <h3 className="text-2xl font-bold mb-6">Project Investment</h3>
