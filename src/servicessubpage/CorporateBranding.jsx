      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-6">
          ...
          <p className="text-gray-300 max-w-3xl mx-auto">
            Complete corporate branding solutions including logo design, brand
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li className="flex items-center gap-3">
              ...
              <span className="text-lg text-gray-300">Brand strategy</span>
            </li>

            <li className="flex items-center gap-3">
              <CheckCircle className="text-[#D4AF37] w-6 h-6" />
              <span className="text-lg text-gray-300">Logo & identity design</span>
            </li>

            <li className="flex items-center gap-3">
              <CheckCircle className="text-[#D4AF37] w-6 h-6" />
              <span className="text-lg text-gray-300">Marketing materials</span>
            </li>

            <li className="flex items-center gap-3">
              <CheckCircle className="text-[#D4AF37] w-6 h-6" />
              <span className="text-lg text-gray-300">Brand guidelines</span>
            </li>

            <li className="flex items-center gap-3">
              <CheckCircle className="text-[#D4AF37] w-6 h-6" />
              <span className="text-lg text-gray-300">Digital assets</span>
            </li>
          </ul>
        </div>
