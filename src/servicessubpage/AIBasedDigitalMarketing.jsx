...
export default function AIBasedDigitalMarketing() {
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        <img
          ...
          alt="AI Based Digital Marketing"
        ...
        <div className="relative z-10 text-center px-6">
          ...
          <p className="text-gray-300 max-w-3xl mx-auto">
            Data-driven digital marketing strategies powered by AI and analytics.
          </p>
        </div>
      </section>
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li className="flex items-center gap-3">
              ...
              <span className="text-lg text-gray-300">AI-powered campaigns</span>
            </li>

            <li className="flex items-center gap-3">
              <CheckCircle className="text-[#D4AF37] w-6 h-6" />
              <span className="text-lg text-gray-300">Social media marketing</span>
            </li>

            <li className="flex items-center gap-3">
              <CheckCircle className="text-[#D4AF37] w-6 h-6" />
              <span className="text-lg text-gray-300">Performance analytics</span>
            </li>

            <li className="flex items-center gap-3">
              <CheckCircle className="text-[#D4AF37] w-6 h-6" />
              <span className="text-lg text-gray-300">Content strategy</span>
            </li>

            <li className="flex items-center gap-3">
              <CheckCircle className="text-[#D4AF37] w-6 h-6" />
              <span className="text-lg text-gray-300">ROI optimization</span>
            </li>
          </ul>
        </div>
