...
import { Music, CheckCircle, Film } from "lucide-react";

export default function MusicVideoAlbums() {
  return (
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-6">
          ...
          <p className="text-gray-300 max-w-3xl mx-auto">
            Cinematic music video production with creative storytelling, high-end visuals,
            professional cinematography, and stunning VFX.
          </p>
        </div>
      </section>
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li className="flex items-center gap-3">
              ...
              <span className="text-lg text-gray-300">Concept development & scripting</span>
            </li>

            <li className="flex items-center gap-3">
              <CheckCircle className="text-[#D4AF37] w-6 h-6" />
              <span className="text-lg text-gray-300">Cinematic shooting & lighting</span>
            </li>

            <li className="flex items-center gap-3">
              <CheckCircle className="text-[#D4AF37] w-6 h-6" />
              <span className="text-lg text-gray-300">Professional color grading</span>
            </li>

            <li className="flex items-center gap-3">
              <CheckCircle className="text-[#D4AF37] w-6 h-6" />
              <span className="text-lg text-gray-300">VFX, animation & motion graphics</span>
            </li>

            <li className="flex items-center gap-3">
              <CheckCircle className="text-[#D4AF37] w-6 h-6" />
              <span className="text-lg text-gray-300">Distribution & promotion support</span>
            </li>
          </ul>
        </div>
